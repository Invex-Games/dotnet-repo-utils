...
/// <param name="DeletedLines">The content of lines that were removed from the file relative to the older commit.</param>
[PublicAPI]
public sealed record Change(RootedPath Path, List<string> AddedLines, List<string> DeletedLines);
